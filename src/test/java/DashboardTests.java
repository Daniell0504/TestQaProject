...
public class DashboardTests extends BaseTest{
    ...
    private String dashboardUrl = "https://ecommerce-playground.lambdatest.io/index.php?route=account/register";
    @BeforeClass
    public void setUpPreconditions() {
        ...
        goToDasbhaord();
        System.out.println("Go to dashboard ... done");
    }
    ...
    @Test
    public void verifyDashboardFirstSection() throws Exception{
